  ...
  <div className="wrapper">
    <nav className="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul className="navbar-nav">
        ...
        <li className="nav-item d-none d-sm-inline-block">
          <Link to="/login" className="nav-link">{location.pathname} {userdata && userdata.name}</Link>
        </li>
      </ul>
      {/* Right navbar links */}
      <ul className="navbar-nav ml-auto">
        ...
        <li className="nav-item dropdown">
          ...
          <div className="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div className="dropdown-divider" />
            <Link to="#" className="dropdown-item dropdown-footer"  >see all message</Link>
          </div>
        </li>
        ...
        <li className="nav-item dropdown">
          ...
          <div className="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div className="dropdown-divider" />
            <Link to="#" className="dropdown-item dropdown-footer" onClick={() => logout()}>Logout</Link>
          </div>
        </li>
        <li className="nav-item">
